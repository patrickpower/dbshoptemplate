...
function enqueues() //Enqueue the CSS & jQuery files...
	{
		...
		wp_enqueue_style( 'style', get_stylesheet_uri(),'','0.5888','' );		// STYLE.CSS
    
		wp_register_script('fontawesome','https://use.fontawesome.com/releases/v5.1.0/js/all.js','','');// FontAwesome
		wp_register_script('scripts', get_template_directory_uri(). '/js/scripts.js',array('jquery'),'0.044',true); // THE TEMPLATE SCRIPTS
